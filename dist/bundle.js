...
/******/ 	var hotCurrentHash = "a0264609e3d210606527"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsBindActionCreators = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rootReducer = (0, _redux.combineReducers)({
	  counter: _counter.counter, content: _counter.content
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "*{margin: 0;padding: 0;font-family:\"\\5FAE\\8F6F\\96C5\\9ED1\";}\n.header{\n\theight: 50px;line-height: 50px;\n}\n.header span{margin-top: 16px;}\n.lbt{\n\t\twidth: 100%;\n\t\theight: 160px;\n}\n.swiper-container{\n\theight: 160px;\n}\n#root section{\n\tmargin: 20px 0;\n\tpadding: 5px 10px;\n\tmargin-bottom: 10px;\n}\n.body-wrap section{\n\t \n\tmargin: 20px 0;\n\tpadding: 5px 10px;\n\tmargin-bottom: 10px;\n}\n.section-text{\n\tmargin-left: 100px;\n\tpadding-left: 10px;\n}\n.pinglun{\n\tmargin-top: 20px;\n}\n.add_pl{\n\t\n}\n.pl-wrap{\n\twidth: 80%;\n\tmargin-left: 3%;\n}\n.add_pl input[name=pinglun]{\n\t\n}\n.add_pl input[type=submit]{\n\n}\n.body-main p {\n\tword-wrap : break-word \n}\n.body-text{\n\tpadding-left: 20px;\n}\n.huifu-user{\n\tmargin-left: 40px;\n}\n.huifu{\n\tmargin-left: 40px;\n}\n.swiper-container img{width: 100%;height: 160px;}\n.img{\n\twidth: 100px;height: 80px;\n}\nfooter{\n\theight: 50px;\n\tline-height: 50px;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	exports.increment1 = increment1;
	exports.increment2 = increment2;
	exports.increment3 = increment3;
	exports.text1 = text1;
	exports.text2 = text2;
	exports.text3 = text3;
	exports.hf1 = hf1;
	exports.hf2 = hf2;
	exports.hf3 = hf3;
	var LOVE_COUNTER_ONE = 'LOVE_COUNTER_ONE';
	exports.LOVE_COUNTER_ONE = LOVE_COUNTER_ONE;
	var LOVE_COUNTER_TWO = 'LOVE_COUNTER_TWO';
	exports.LOVE_COUNTER_TWO = LOVE_COUNTER_TWO;
	var LOVE_COUNTER_THREE = 'LOVE_COUNTER_THREE';

	exports.LOVE_COUNTER_THREE = LOVE_COUNTER_THREE;
	var TXST_COUNTER_ONE = 'TXST_COUNTER_ONE';
	exports.TXST_COUNTER_ONE = TXST_COUNTER_ONE;
	var TXST_COUNTER_TWO = 'TXST_COUNTER_TWO';
	exports.TXST_COUNTER_TWO = TXST_COUNTER_TWO;
	var TXST_COUNTER_THREE = 'TXST_COUNTER_THREE';

	exports.TXST_COUNTER_THREE = TXST_COUNTER_THREE;
	var HF_COUNTER_ONE = 'HF_COUNTER_ONE';
	exports.HF_COUNTER_ONE = HF_COUNTER_ONE;
	var HF_COUNTER_TWO = 'HF_COUNTER_TWO';
	exports.HF_COUNTER_TWO = HF_COUNTER_TWO;
	var HF_COUNTER_THREE = 'HF_COUNTER_THREE';
	exports.HF_COUNTER_THREE = HF_COUNTER_THREE;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsProvider = __webpack_require__(123);
	    ...
	    return _react2["default"].createElement(
	      ...
	      _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "span",
	            { className: "pull-right heart", style: { color: 'red' }, onClick: this.props.ince },
	            _react2["default"].createElement("i", { className: "glyphicon glyphicon-heart" }),
	            this.props.counter
	          ),
	          _react2["default"].createElement(
	            "a",
	            { className: "pull-right plbtn", onClick: this.displayContent, style: { marginRight: '20px' } },
	            "评论"
	          )
	        )
	      ),
	      this.state.display ? _react2["default"].createElement(TextContent, { id: this.props.id, text: this.props.text, hf: this.props.hf, data: this.props.data }) : null
	    );
	  }
	});
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            ...
	            _react2["default"].createElement("input", { className: "form-control pl-input", ref: "add", name: "pinglun", type: "text", placeholder: "这里可以添加评论的哦~" })
	          ),
	          _react2["default"].createElement("input", { className: "btn btn-primary pingl", type: "submit", onClick: this.AddContent.bind(this), value: "提交" })
	        ),
	        _react2["default"].createElement(
	          "div",
	          { className: "body-main" },
	          data[newId].map(function (items, keys) {
	            return _react2["default"].createElement(
	              ...
	              _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                  "a",
	                  { className: "hf", onClick: that.handleClick.bind(that, keys) },
	                  "回复"
	                ),
	                " ",
	                _react2["default"].createElement(
	        ...
	        that.state.display ? _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "div",
	            { className: "pl-wrap pull-left" },
	            _react2["default"].createElement("input", { className: "form-control hf-input", ref: "addHf", name: "pinglun", type: "text", placeholder: "这里可以添加评论的哦~" })
	          ),
	          _react2["default"].createElement("input", { className: "btn btn-warning hf-btn", type: "submit", onClick: that.handleAddHf.bind(that), value: "提交" })
	        ) : null
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsCounter = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeConfigureStore = __webpack_require__(105);

	var _storeConfigureStore2 = _interopRequireDefault(_storeConfigureStore);

	__webpack_require__(190);

	var _publicJsSwiper331MinJs = __webpack_require__(102);

	var _publicJsSwiper331MinJs2 = _interopRequireDefault(_publicJsSwiper331MinJs);
	  ...
	  "use strict";function e(e) {
	    ...
	    function s(e) {
	      ...
	      e.originalEvent && (e = e.originalEvent);var a = b.mousewheel.event,
	          t = 0,
	          r = b.rtl ? -1 : 1;if ("mousewheel" === a) if (b.params.mousewheelForceToAxis) if (b.isHorizontal()) {
	      ...
	      return 0 !== e.indexOf("on") && (e = e[0] !== e[0].toUpperCase() ? "on" + e[0].toUpperCase() + e.substring(1) : "on" + e), e;
	        ...
	        h = i && i.virtualTranslate;i = i || {};var f = {};for (var g in i) if ("object" != typeof i[g] || null === i[g] || i[g].nodeType || i[g] === window || i[g] === document || "undefined" != typeof r && i[g] instanceof r || "undefined" != typeof jQuery && i[g] instanceof jQuery) f[g] = i[g];else {
	      f[g] = {};for (var v in i[g]) f[g][v] = i[g][v];
	    }for (var w in m) if ("undefined" == typeof i[w]) i[w] = m[w];else if ("object" == typeof i[w]) for (var y in m[w]) "undefined" == typeof i[w][y] && (i[w][y] = m[w][y]);var b = this;if ((b.params = i, b.originalParams = f, b.classNames = [], "undefined" != typeof a && "undefined" != typeof r && (a = r), ("undefined" != typeof a || (a = "undefined" == typeof r ? window.Dom7 || window.Zepto || window.jQuery : r)) && (b.$ = a, b.currentBreakpoint = void 0, b.getActiveBreakpoint = function () {
	      ...
	      var e = b.getActiveBreakpoint();if (e && b.currentBreakpoint !== e) {
	        var a = e in b.params.breakpoints ? b.params.breakpoints[e] : b.originalParams,
	            t = b.params.loop && a.slidesPerView !== b.params.slidesPerView;for (var r in a) b.params[r] = a[r];b.currentBreakpoint = e, t && b.destroyLoop && b.reLoop(!0);
	      }
	      ...
	      if (b.container.length > 1) {
	        ...
	        b.slides = b.wrapper.children("." + b.params.slideClass), b.snapGrid = [], b.slidesGrid = [], b.slidesSizesGrid = [];var e,
	          ...
	          "string" == typeof a && a.indexOf("%") >= 0 && (a = parseFloat(a.replace("%", "")) / 100 * b.size), b.virtualSize = -a, b.rtl ? b.slides.css({ marginLeft: "", marginTop: "" }) : b.slides.css({ marginRight: "", marginBottom: "" });var n;b.params.slidesPerColumn > 1 && (n = Math.floor(b.slides.length / b.params.slidesPerColumn) === b.slides.length / b.params.slidesPerColumn ? b.slides.length : Math.ceil(b.slides.length / b.params.slidesPerColumn) * b.params.slidesPerColumn, "auto" !== b.params.slidesPerView && "row" === b.params.slidesPerColumnFill && (n = Math.max(n, b.params.slidesPerView * b.params.slidesPerColumn)));var o,
	            ...
	            for (f = [], e = 0; e < b.snapGrid.length; e++) b.snapGrid[e] < b.virtualSize + b.snapGrid[0] && f.push(b.snapGrid[e]);b.snapGrid = f;
	          }if (!b.params.centeredSlides) {
	            for (f = [], e = 0; e < b.snapGrid.length; e++) b.snapGrid[e] <= b.virtualSize - b.size && f.push(b.snapGrid[e]);b.snapGrid = f, Math.floor(b.virtualSize - b.size) - Math.floor(b.snapGrid[b.snapGrid.length - 1]) > 1 && b.snapGrid.push(b.virtualSize - b.size);
	        ...
	        if (b.params.pagination && b.paginationContainer && b.paginationContainer.length > 0) {
	          var e = "";if ("bullets" === b.params.paginationType) {
	            for (var a = b.params.loop ? Math.ceil((b.slides.length - 2 * b.loopedSlides) / b.params.slidesPerGroup) : b.snapGrid.length, t = 0; a > t; t++) e += b.params.paginationBulletRender ? b.params.paginationBulletRender(t, b.params.bulletClass) : "<" + b.params.paginationElement + ' class="' + b.params.bulletClass + '"></' + b.params.paginationElement + ">";b.paginationContainer.html(e), b.bullets = b.paginationContainer.find("." + b.params.bulletClass), b.params.paginationClickable && b.params.a11y && b.a11y && b.a11y.initPagination();
	        ...
	        var t = o(e, "." + b.params.slideClass),
	            r = !1;if (t) for (var i = 0; i < b.slides.length; i++) b.slides[i] === t && (r = !0);if (!t || !r) return b.clickedSlide = void 0, void (b.clickedIndex = void 0);if ((b.clickedSlide = t, b.clickedIndex = a(t).index(), b.params.slideToClickedSlide && void 0 !== b.clickedIndex && b.clickedIndex !== b.activeIndex)) {
	          var s,
	        ...
	        if ((e.originalEvent && (e = e.originalEvent), z && b.emit("onTouchEnd", b, e), z = !1, S)) {
	          b.params.grabCursor && C && S && (b.container[0].style.cursor = "move", b.container[0].style.cursor = "-webkit-grab", b.container[0].style.cursor = "-moz-grab", b.container[0].style.cursor = "grab");var t = Date.now(),
	            ...
	            if (i < -b.minTranslate()) return void b.slideTo(b.activeIndex);if (i > -b.maxTranslate()) return void (b.slides.length < b.snapGrid.length ? b.slideTo(b.snapGrid.length - 1) : b.slideTo(b.slides.length - 1));if (b.params.freeModeMomentum) {
	              ...
	              w = 0,
	              y = b.slidesSizesGrid[0];for (v = 0; v < b.slidesGrid.length; v += b.params.slidesPerGroup) "undefined" != typeof b.slidesGrid[v + b.params.slidesPerGroup] ? i >= b.slidesGrid[v] && i < b.slidesGrid[v + b.params.slidesPerGroup] && (w = v, y = b.slidesGrid[v + b.params.slidesPerGroup] - b.slidesGrid[v]) : i >= b.slidesGrid[v] && (w = v, y = b.slidesGrid[b.slidesGrid.length - 1] - b.slidesGrid[b.slidesGrid.length - 2]);var x = (i - b.slidesGrid[w]) / y;if (r > b.params.longSwipesMs) {
	        ...
	        }), t = 0; t < i.length; t++) b.wrapper.append(a(i[t].cloneNode(!0)).addClass(b.params.slideDuplicateClass));for (t = r.length - 1; t >= 0; t--) b.wrapper.prepend(a(r[t].cloneNode(!0)).addClass(b.params.slideDuplicateClass));
	        ...
	        for (var e = [], a = 0; a < b.slides.length; a++) e.push(a);b.removeSlide(e);
	            ...
	            if ((b.slides.transition(e).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(e), b.params.virtualTranslate && 0 !== e)) {
	              var t = !1;b.slides.eq(b.activeIndex).transitionEnd(function () {
	                if (!t && b && a(this).hasClass(b.params.slideActiveClass)) {
	                  t = !0, b.animating = !1;for (var e = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], r = 0; r < e.length; r++) b.wrapper.trigger(e[r]);
	                }
	              });
	            }
	          ...
	          });else if (b.params.slidesPerView > 1) for (e = b.activeIndex; e < b.activeIndex + b.params.slidesPerView; e++) b.slides[e] && b.lazy.loadImageInSlide(e);else b.lazy.loadImageInSlide(b.activeIndex);if (b.params.lazyLoadingInPrevNext) if (b.params.slidesPerView > 1 || b.params.lazyLoadingInPrevNextAmount && b.params.lazyLoadingInPrevNextAmount > 1) {
	          ...
	          this.x = e, this.y = a, this.lastIndex = e.length - 1;var t, r;this.x.length;this.interpolate = function (e) {
	            ...
	            var e, a, t;return function (r, i) {
	              for (a = -1, e = r.length; e - a > 1;) r[t = e + a >> 1] <= i ? a = t : e = t;return e;
	            };
	          })();
	    ...
	    var e = function e(_e) {
	      ...
	      var r = [],
	        ...
	        var s,
	          ...
	          var l = "div";for (0 === o.indexOf("<li") && (l = "ul"), 0 === o.indexOf("<tr") && (l = "tbody"), (0 === o.indexOf("<td") || 0 === o.indexOf("<th")) && (l = "tr"), 0 === o.indexOf("<tbody") && (l = "table"), 0 === o.indexOf("<option") && (l = "select"), n = document.createElement(l), n.innerHTML = _a, i = 0; i < n.childNodes.length; i++) r.push(n.childNodes[i]);
	        } else for (s = t || "#" !== _a[0] || _a.match(/[ .<>:~]/) ? (t || document).querySelectorAll(_a) : [document.getElementById(_a.split("#")[1])], i = 0; i < s.length; i++) s[i] && r.push(s[i]);
	      } else if (_a.nodeType || _a === window || _a === document) r.push(_a);else if (_a.length > 0 && _a[0].nodeType) for (i = 0; i < _a.length; i++) r.push(_a[i]);return new e(r);
	        ...
	        function s(e) {
	          var i = e.target;if (a(i).is(t)) r.call(i, e);else for (var s = a(i).parents(), n = 0; n < s.length; n++) a(s[n]).is(t) && r.call(s[n], e);
	        }var n,
	            o,
	            l = e.split(" ");for (n = 0; n < this.length; n++) if ("function" == typeof t || t === !1) for ("function" == typeof t && (r = arguments[1], i = arguments[2] || !1), o = 0; o < l.length; o++) this[n].addEventListener(l[o], r, i);else for (o = 0; o < l.length; o++) this[n].dom7LiveListeners || (this[n].dom7LiveListeners = []), this[n].dom7LiveListeners.push({ listener: r, liveListener: s }), this[n].addEventListener(l[o], s, i);return this;
	        ...
	        if (!this[0]) return !1;var r, i;if ("string" == typeof t) {
	          var s = this[0];if (s === document) return t === document;if (s === window) return t === window;if (s.matches) return s.matches(t);if (s.webkitMatchesSelector) return s.webkitMatchesSelector(t);if (s.mozMatchesSelector) return s.mozMatchesSelector(t);if (s.msMatchesSelector) return s.msMatchesSelector(t);for (r = a(t), i = 0; i < r.length; i++) if (r[i] === this[0]) return !0;return !1;
	        }if (t === document) return this[0] === document;if (t === window) return this[0] === window;if (t.nodeType || t instanceof e) {
	          for (r = t.nodeType ? [t] : t, i = 0; i < r.length; i++) if (r[i] === this[0]) return !0;return !1;
	        }return !1;
	        ...
	        var t, r;for (t = 0; t < this.length; t++) if ("string" == typeof a) {
	          var i = document.createElement("div");for (i.innerHTML = a, r = i.childNodes.length - 1; r >= 0; r--) this[t].insertBefore(i.childNodes[r], this[t].childNodes[0]);
	        ...
	        for (var t = [], r = 0; r < this.length; r++) for (var i = this[r].parentNode; i;) e ? a(i).is(e) && t.push(i) : t.push(i), i = i.parentNode;return a(a.unique(t));
	      }, find: function find(a) {
	        for (var t = [], r = 0; r < this.length; r++) for (var i = this[r].querySelectorAll(a), s = 0; s < i.length; s++) t.push(i[s]);return new e(t);
	      }, children: function children(t) {
	        for (var r = [], i = 0; i < this.length; i++) for (var s = this[i].childNodes, n = 0; n < s.length; n++) t ? 1 === s[n].nodeType && a(s[n]).is(t) && r.push(s[n]) : 1 === s[n].nodeType && r.push(s[n]);return new e(a.unique(r));
	        ...
	        var e,
	          ...
	          var i = a(arguments[e]);for (t = 0; t < i.length; t++) r[r.length] = i[t], r.length++;
	        }return r;
	      } }, a.fn = e.prototype, a.unique = function (e) {
	      for (var a = [], t = 0; t < e.length; t++) -1 === a.indexOf(e[t]) && a.push(e[t]);return a;
	    }, a;
	  })(), i = ["jQuery", "Zepto", "Dom7"], s = 0; s < i.length; s++) window[i[s]] && e(window[i[s]]);var n;n = "undefined" == typeof r ? window.Dom7 || window.Zepto || window.jQuery : r, n && ("transitionEnd" in n.fn || (n.fn.transitionEnd = function (e) {
	    function a(s) {
	      if (s.target === this) for (e.call(this, s), t = 0; t < r.length; t++) i.off(r[t], a);
	    }var t,
	        r = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"],
...
/***/ function(module, exports, __webpack_require__) {
	...
	function counter(state, action) {
	  if (state === undefined) state = { one: { id: 1, counter: 0, title: "好险，库里将到手的锅一脚踢飞！", time: 1 }, two: { id: 2, counter: 0, title: "中国男足赔率1：501！", time: 42 }, three: { id: 3, counter: 0, title: "为什么要善待高洪波和宫鲁鸣", time: 1 } };

	  switch (action.type) {
	    case _actionsCounter.LOVE_COUNTER_ONE:
	      return Object.assign({}, state, { one: { id: 1, counter: state.one.counter + 1, title: state.one.title, time: state.one.time } });
	    case _actionsCounter.LOVE_COUNTER_TWO:
	      return Object.assign({}, state, { two: { id: 2, counter: state.two.counter + 1, title: state.two.title, time: state.two.time } });
	    case _actionsCounter.LOVE_COUNTER_THREE:
	      return Object.assign({}, state, { three: { id: 3, counter: state.three.counter + 1, title: state.three.title, time: state.three.time } });
	    default:
	      return state;
	  }
	}
	...
	function content(state, action) {
	  if (state === undefined) state = [[{ text: "这里是评论1", huifu: ["huifuxxxxxxxxxxxxx"] }, { text: "这里是评论1.2", huifu: [] }], [{ text: "这里是评论2", huifu: ["huifuxxxxxxxxxxxxx"] }], [{ text: "这里是评论3", huifu: ["huifuxxxxxxxxxxxxx"] }]];

	  switch (action.type) {
	    case _actionsCounter.TXST_COUNTER_ONE:
	      var newState = deepClone(state);
	      newState[0].push({ text: action.text, huifu: [] });
	      return newState;
	    case _actionsCounter.TXST_COUNTER_TWO:
	      var newState1 = deepClone(state);
	      newState1[1].push({ text: action.text, huifu: [] });
	      return newState1;
	    case _actionsCounter.TXST_COUNTER_THREE:
	      var newState2 = deepClone(state);
	      newState2[2].push({ text: action.text, huifu: [] });
	      return newState2;

	    case _actionsCounter.HF_COUNTER_ONE:
	      var HfState = deepClone(state);
	      HfState[0][action.id].huifu.push(action.hf);
	      return HfState;
	    case _actionsCounter.HF_COUNTER_TWO:
	      var HfState1 = deepClone(state);
	      HfState1[1][action.id].huifu.push(action.hf);
	      return HfState1;
	    case _actionsCounter.HF_COUNTER_THREE:
	      var HfState2 = deepClone(state);
	...
	function configureStore(initialState) {
	  ...
	  if (true) {
	    ...
	    module.hot.accept(34, function () {
	      var nextReducer = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsStoreShape = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsShallowEqual = __webpack_require__(126);

	var _utilsShallowEqual2 = _interopRequireDefault(_utilsShallowEqual);

	var _utilsIsPlainObject = __webpack_require__(125);
